...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "dlgContactsReload" : MessageLookupByLibrary.simpleMessage("Перезагрузить список контактов"),
    "dlgContactsReorder" : MessageLookupByLibrary.simpleMessage("Изменение порядка контакты"),
    "dlgEditTitle" : MessageLookupByLibrary.simpleMessage("Редактировать избранное"),
